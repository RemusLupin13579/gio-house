...
<template>
  <div class="w-full min-w-0 overflow-hidden">
    ...
    <div class="shrink-0">
      ...
      >
        <div
          class="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 overflow-hidden flex items-center justify-center"
        >
    ...
    <div class="flex-1 min-h-0 overflow-y-auto pr-1 dm-scroll">
      <div class="space-y-1">
        ...
        >
          <div
            class="w-10 h-10 rounded-2xl border border-white/10 overflow-hidden bg-white/5 flex items-center justify-center"
          >
            <img
              v-if="t.otherProfile?.avatar_url"
              :src="t.otherProfile.avatar_url"
          ...
          <div class="min-w-0 text-left flex-1">
            <div class="font-bold truncate flex items-center gap-2">
              <span :class="(t.unread || 0) > 0 ? 'text-green-300' : ''">
                {{ displayTitle(t) }}
              </span>
        ...
        <div v-if="loading" class="text-xs text-white/50 px-2 py-3">טוען שיחות…</div>
